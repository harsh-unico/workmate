    ...
    >
      <DashboardSectionCard title="Settings">
        <p style={{ margin: 0, color: t.colors.textMutedDark, fontSize: t.font.size.md }}>
          This section will allow you to configure organisation-level settings such as roles, permissions,
          notifications, and integrations for {organisationName}. Replace this placeholder with the actual settings
          forms and controls.
        </p>
